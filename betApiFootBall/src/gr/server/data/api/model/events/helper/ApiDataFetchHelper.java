...
//			if (league == null) {
//				LeagueWithData leagueWithData = FootballApiCache.LEAGUES.get(event.getLeague_id());
//				if (leagueWithData == null) {//can be null because we fetch mock leagues to reduce calls
...
//					leagueWithData = new LeagueWithData();
//					leagueWithData.setLeague(league);
//					league.setSection(section);
//					FootballApiCache.LEAGUES.put(event.getLeague_id(), leagueWithData);
//				}else {
//					league = leagueWithData.getLeague();
//				}
...
//	}
//	
//	private static Section createDummySection() {
//		Section section = new Section();
//		section.setId(Integer.MIN_VALUE);
//		section.setName("Other Section");
//		section.setPriority(0);
